...
describe('AutoAdvances()', () => {
    ...
    const MockComponentWithAtutoAdvance = AutoAdvances(
        MockComponent,
        'index',
        'upperBound'
    );
    ...
    it('has the expected displayName', () => {
        expect(MockComponentWithAtutoAdvance.displayName).toBe(
    ...
    it('does not set a timer if `autoAdvanceDelay is`', () => {
